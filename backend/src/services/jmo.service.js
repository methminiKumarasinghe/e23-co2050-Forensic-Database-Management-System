...
const getJmoSpecimens = async (userId) => {
    ...
    // Fallback: If no specimens are linked specifically to this JMO, load all collected specimens in database
...
const createLabRequest = async (userId, { specimenId, laboratoryId, testName, priority = 'NORMAL', clinicalNotes }) => {
    ...
    return withTransaction(async (client) => {
        ...
        // Create initial laboratory_test if testName provided
        if (testName) {
            await client.query(`
