...
const StatCard = ({ icon, title, value, colorClass }) => (
  <div className={`glass rounded-xl p-5 border-l-4 ${colorClass} flex items-center justify-between`}>
    <div>
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
              <StatCard icon="📥" title="Today's Requests" value={stats.todayRequests} colorClass="border-blue-500" />
              <StatCard icon="⏳" title="Pending Requests" value={stats.pending} colorClass="border-amber-500" />
              <StatCard icon="✓" title="Accepted Requests" value={stats.accepted} colorClass="border-green-500" />
              <StatCard icon="⚗️" title="Tests in Progress" value={stats.processing} colorClass="border-yellow-500" />
              <StatCard icon="📊" title="Completed Tests" value={stats.completed} colorClass="border-purple-500" />
            </div>
