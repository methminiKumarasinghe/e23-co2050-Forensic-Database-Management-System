...
const LabResultDetails = () => {
  ...
  const getFileUrl = (filePath) => {
    // filePath is like "d:\...\uploads\uuid-time.pdf" or just "uploads/uuid-time.pdf"
    // Since backend serves static via /uploads, we need the basename
    const fileName = filePath.split(/[\\/]/).pop();
    return `http://localhost:5000/uploads/${fileName}`; // Ideally use config/env for API URL
  };
